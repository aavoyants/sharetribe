class PaypalAccountsController < ApplicationController
  ...
  def show
    ...
    return redirect_to action: :new unless PaypalHelper.personal_account_prepared?(m_account)
  ...
  def new
    ...
    return redirect_to action: :show if PaypalHelper.personal_account_prepared?(m_account)
